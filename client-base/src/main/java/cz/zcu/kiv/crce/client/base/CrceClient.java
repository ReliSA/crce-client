...
public interface CrceClient {
	...
	/**
	 * * This method connect to the server and return list of metadata filtered by
	 * {@link cz.zcu.kiv.crce.client.base.metadata.Requirements}
	 *
	 ...
	 * @throws java.io.IOException
	 */
	void getResourceBinary(String id, OutputStream stream) throws IOException;
